...
/* Can only run on Windows due to <conio.h> header */
...
int login_scr() {
    ...
    char input[BUFFER_SIZE], prompt[BUFFER_SIZE], ch = 0;
    int input_size;
...
int transfer_scr() {
    ...
    char input[BUFFER_SIZE], ch = 0, money_str[main_meta.data_sizes[3] + 10];
